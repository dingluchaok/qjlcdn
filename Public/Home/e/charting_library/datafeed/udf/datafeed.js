...
Datafeeds.UDFCompatibleDatafeed.prototype.getMarks = function (symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
    if (this._configuration.supports_marks) {
        this._send(this._datafeedURL + '/marks', {
            ...
            .done(function (response) {
                //response='{"id":[0,1,2,3,4,5],"time":[1513555200,1513209600,1512950400,1512950400,1512259200,1510963200],"color":["red","blue","green","red","blue","green"],"text":["Today","4 days back","7 days back + Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","7 days back once again","15 days back","30 days back"],"label":["A","B","CORE","D","EURO","F"],"labelFontColor":["white","white","red","#FFFFFF","white","#000"],"minSize":[14,28,7,40,7,14]}';
                response = "[]";
...
Datafeeds.UDFCompatibleDatafeed.prototype.getTimescaleMarks = function (symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
    if (this._configuration.supports_timescale_marks) {
        this._send(this._datafeedURL + '/timescale_marks', {
            ...
            .done(function (response) {
                //response = '[{"id":"tsm1","time":1513555200,"color":"red","label":"A","tooltip":""},{"id":"tsm2","time":1513209600,"color":"blue","label":"D","tooltip":["Dividends: $0.56","Date: Thu Dec 14 2017"]},{"id":"tsm3","time":1512950400,"color":"green","label":"D","tooltip":["Dividends: $3.46","Date: Mon Dec 11 2017"]},{"id":"tsm4","time":1512259200,"color":"#999999","label":"E","tooltip":["Earnings: $3.44","Estimate: $3.60"]},{"id":"tsm7","time":1510963200,"color":"red","label":"E","tooltip":["Earnings: $5.40","Estimate: $5.00"]}]'
                response = "[]";
                onDataCallback(parseJSONorNot(response));
            })
            .fail(function () {
    ...
    if (this._configuration.supports_search) {
        this._send(this._datafeedURL + '/search', {
            ...
            .done(function (response) {
                ...
                //console.log(response + "========search  搜索======");
...
Datafeeds.UDFCompatibleDatafeed.prototype.resolveSymbol = function (symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
    ...
    if (!this._configuration.supports_group_request) {
        this._send(this._datafeedURL + this._symbolResolveURL, {
            ...
            .done(function (response) {
                //response = '{"name":"liujh","exchange-traded":"NasdaqNM","exchange-listed":"NasdaqNM","timezone":"Asia/Shanghai","minmov":1,"minmov2":0,"pointvalue":1,"session":"0930-1630","has_intraday":false,"has_no_volume":false,"description":"liujh Inc.","type":"stock","supported_resolutions":["D","2D","3D","W","3W","M","6M"],"pricescale":100,"ticker":"AAPL"}';
                //response = '{"ticker":"AAPL","symbol":"'+$("#sellShortName").val()+'","timezone":"Asia/Shanghai","name":"'+$("#sellShortName").val()+'","description":"","pricescale":1000000,"minmov":1,"minmove2":0,"fractional":false,"supported_resolutions":["1","5","10","15","30","60","1D","1W","1M","3M","6M","12M"],"has_intraday":true,"intraday_multipliers":["1","5","10","15","30","60"],"has_daily":true,"has_weekly_and_monthly":false,"has_no_volume":false,"has_empty_bars":false,"force_session_rebuild":true,"volume_precision":"0","expired":false,"data_status":"delayed_streaming","session":"24x7"}';
                //response = '{"name":"EUR\/USD","exchange-traded":null,"exchange-listed":" ","timezone":"Asia\/Shanghai","minmov":1,"minmov2":0,"pricescale":10000,"pointvalue":1,"has_intraday":true,"has_no_volume":true,"volume_precision":0,"ticker":"1","description":"EUR\/USD","type":"FX","has_daily":true,"has_weekly_and_monthly":true,"supported_resolutions":["1","5","15","30","60","300","D","W","M","45","120","240"],"intraday_multipliers":["1","5","15","30","60","300"],"session":"2;0000-2359:23456","data_status":"streaming"}';
                var data = parseJSONorNot(response);
                if (data.s && data.s !== 'ok') {
...
//     })
    ...
    //["1","5","10","15","30","60","1D","1W","1M","3M","6M","12M"]
    var param = {
        symbol: symbolInfo.ticker.toUpperCase(),
        resolution: resolution,
        from: rangeStartDate,
    ...
    this._send(this._datafeedURL + this._historyURL, param)
        .done(function (response) {
            //console.log("========数据 data======");
            // response='{"t":[1512950400,1513036800,1513123200,1513209600,1513296000],"o":[169.2,172.15,172.5,172.4,173.63],"h":[172.89,172.39,173.54,173.13,174.17],"l":[168.79,171.461,172,171.65,172.46],"c":[172.67,171.7,172.27,172.22,173.87],"v":[33092051,18945457,23142242,20219307,37054632],"s":"ok"}';
            var data = parseJSONorNot(response);
            //console.log(data);
