...
class AppController extends AdminController
{
	...
	public function ads_user()
	{
		...
		$where = array();
		$count = $this->Model->join('mollymobi_user ON mollymobi_user.id = mollymobi_app_vipuser.uid')->join('mollymobi_app_vip ON mollymobi_app_vip.id = mollymobi_app_vipuser.vip_id')->field('mollymobi_user.username,mollymobi_app_vipuser.*,mollymobi_app_vip.name as vip_name,mollymobi_app_vip.tag')->where($where)->count();
		$Page = new \Think\Page($count, 15);
		$show = $Page->show();
		$list = $this->Model->join('mollymobi_user ON mollymobi_user.id = mollymobi_app_vipuser.uid')->join('mollymobi_app_vip ON mollymobi_app_vip.id = mollymobi_app_vipuser.vip_id')->field('mollymobi_user.username,mollymobi_app_vipuser.*,mollymobi_app_vip.name as vip_name,mollymobi_app_vip.tag')->where($where)->order('id desc')->limit($Page->firstRow . ',' . $Page->listRows)->select();
		$this->assign('list', $list);
